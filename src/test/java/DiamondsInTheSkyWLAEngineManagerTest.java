...
public class DiamondsInTheSkyWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DiamondsInTheSkyWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DiamondsInTheSkyIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DiamondsInTheSkyIW/InitOutcome.xml").getDocumentElement();
